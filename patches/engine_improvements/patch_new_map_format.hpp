 ...
 */
class PatchNewMapFormat : public GamePatch
{
public:
...
private:
    static constexpr uint16_t LINE_SIZE_IN_WORDS = 74;
    static constexpr uint16_t LINE_SIZE_IN_BYTES = LINE_SIZE_IN_WORDS * 2;
