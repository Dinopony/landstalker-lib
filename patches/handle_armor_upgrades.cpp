...
[[nodiscard]] static uint32_t inject_function_alter_item_in_d0(md::ROM& rom)
{
    ...
    func_alter_item_in_d0.blt("return");
    func_alter_item_in_d0.cmpib(ITEM_HYPER_BREAST, reg_D0);
    func_alter_item_in_d0.bgt("return");
                                                                                ...
                                                                                uint32_t function_alter_item_in_d0)
{
    ...
    func_alter_item_given_by_ground_source.bgt("return");
    func_alter_item_given_by_ground_source.cmpib(ITEM_STEEL_BREAST, reg_D0);
    func_alter_item_given_by_ground_source.blt("return");
    ...
    func_alter_item_given_by_ground_source.label("return");
                                                  ...
                                                  uint32_t function_change_item_in_reward_textbox)
{
    ...
    func_alter_visible_item_for_ground_source.bgt("place_item");
    func_alter_visible_item_for_ground_source.cmpib(ITEM_STEEL_BREAST, reg_D0);
    func_alter_visible_item_for_ground_source.blt("place_item");
    ...
    func_alter_visible_item_for_ground_source.bne("already_taken");
    ...
    func_alter_visible_item_for_ground_source.bra("place_item");

    // Item was already taken, remove it by filling it with an empty item
    func_alter_visible_item_for_ground_source.label("already_taken");
    func_alter_visible_item_for_ground_source.movew(ITEM_NONE, reg_D0);
    func_alter_visible_item_for_ground_source.label("place_item");
