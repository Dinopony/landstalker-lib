...
private:
    ...
    static void write_entity_type_palettes(md::ROM& rom, const World& world);
    ...
    static void write_maps_key_door_masks(md::ROM& rom, const World& world);
