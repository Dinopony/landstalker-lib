...
{    
    ...
    constexpr uint32_t FAHL_ENEMIES_TABLE = 0x12CE6;
    ...
    constexpr uint32_t MAP_CLEAR_KEY_DOOR_FLAGS_TABLE_END = 0x1AAF6;
    constexpr uint32_t PERSISTENCE_FLAGS_TABLE = MAP_CLEAR_KEY_DOOR_FLAGS_TABLE_END;
    constexpr uint32_t PERSISTENCE_FLAGS_TABLE_END = 0x1ABA8;
