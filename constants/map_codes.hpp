...
constexpr uint16_t MAP_MECATOR_CASTLE_TOWER_FALL = 34;
constexpr uint16_t MAP_MECATOR_CASTLE_TOWER_SUMMIT = 35;
...
constexpr uint16_t MAP_MERCATOR_CASTLE_ARMORY_BARRACKS = 64;
...
constexpr uint16_t MAP_MERCATOR_CASTLE_ARMORY_0F_INVADED = 79;
...
constexpr uint16_t MAP_KN_PALACE_JAR_AND_MOVING_PLATFORM_ROOM = 126;
...
constexpr uint16_t MAP_KN_CAVE_ROOM_WITH_WHITE_GOLEMS = 165;
constexpr uint16_t MAP_KN_CAVE_ROOM_WITH_WHITE_GOLEMS_VARIANT = 166;
...
constexpr uint16_t MAP_THIEVES_HIDEOUT_ENTRANCE = 185;
constexpr uint16_t MAP_THIEVES_HIDEOUT_ENTRANCE_WATERLESS = 186;
constexpr uint16_t MAP_THIEVES_HIDEOUT_POCKETS_CELL_ACCESS_1 = 187;
...
constexpr uint16_t MAP_THIEVES_HIDEOUT_DOOR_BEHIND_WATERFALL = 192;
constexpr uint16_t MAP_THIEVES_HIDEOUT_DOOR_BEHIND_WATERFALL_WATERLESS = 193;
constexpr uint16_t MAP_THIEVES_HIDEOUT_194 = 194;
constexpr uint16_t MAP_THIEVES_HIDEOUT_195 = 195;
constexpr uint16_t MAP_THIEVES_HIDEOUT_BACK_ACCESS = 196;
...
constexpr uint16_t MAP_THIEVES_HIDEOUT_EXTERIOR_SUMMIT = 226;
...
constexpr uint16_t MAP_VERLA_MINES_JAR_STAIRCASE_RIDDLE_ROOM = 235;
...
constexpr uint16_t MAP_VERLA_MINES_DEX_ARENA = 242;
...
constexpr uint16_t MAP_VERLA_MINES_SLASHER_ARENA = 255;
...
constexpr uint16_t MAP_VERLA_MINES_MARLEY_LAVA_ROOM_MOVING_PLATFORMS = 264;
constexpr uint16_t MAP_VERLA_MINES_CHEST_ROOM_AFTER_LAVA_WALK = 265;
constexpr uint16_t MAP_VERLA_MINES_266 = 266;
constexpr uint16_t MAP_VERLA_MINES_LIZARDS_LAVA_ROOM_MARLEY_SECTOR = 267;
...
constexpr uint16_t MAP_DESTEL_WELL_WATERY_HUB = 283;
...
constexpr uint16_t MAP_DESTEL_WELL_WATERY_ROOM_BEFORE_BOSS = 287;
...
constexpr uint16_t MAP_LAKE_SHRINE_SAVE_ROOM = 305;
constexpr uint16_t MAP_LAKE_SHRINE_0F_KEYDOOR = 306;
constexpr uint16_t MAP_LAKE_SHRINE_307 = 307;
constexpr uint16_t MAP_LAKE_SHRINE_ENTRANCE = 308;
...
constexpr uint16_t MAP_KN_LABYRINTH_ROOM_ABOVE_IRON_BOOTS = 373;
...
constexpr uint16_t MAP_KN_LABYRINTH_ICE_PATH_TO_KN_PALACE = 388;
...
constexpr uint16_t MAP_KN_LABYRINTH_SAVE_ROOM = 392;
constexpr uint16_t MAP_KN_LABYRINTH_SPIRAL_ROOM = 393;
...
constexpr uint16_t MAP_ROUTE_GUMI_RYUMA_TIBOR_CROSSROADS = 451;
constexpr uint16_t MAP_452 = 452;
constexpr uint16_t MAP_453 = 453;
constexpr uint16_t MAP_ROUTE_GUMI_RYUMA_MERCATOR_GATES = 454;
constexpr uint16_t MAP_455 = 455;
constexpr uint16_t MAP_456 = 456;
constexpr uint16_t MAP_457 = 457;
constexpr uint16_t MAP_458 = 458;
constexpr uint16_t MAP_MIR_SECTOR_CAVERN_ENTRANCE_TO_VERLA = 459;
constexpr uint16_t MAP_460 = 460;
constexpr uint16_t MAP_461 = 461;
constexpr uint16_t MAP_462 = 462;
constexpr uint16_t MAP_VERLA_SECTOR_ACCESS_CAVERN_EXIT = 463;
constexpr uint16_t MAP_MIR_TOWER_SECTOR_ROUTE_TO_TOWER_1 = 464;
constexpr uint16_t MAP_MIR_TOWER_SECTOR_ROUTE_TO_TOWER_2 = 465;
constexpr uint16_t MAP_VERLA_SECTOR_ACCESS_CAVERN = 466;
constexpr uint16_t MAP_VERLA_SHORE_LOWER = 467;
constexpr uint16_t MAP_468 = 468;
constexpr uint16_t MAP_469 = 469;
constexpr uint16_t MAP_470 = 470;
constexpr uint16_t MAP_VERLA_MINES_EXIT_TO_DESTEL = 471;
constexpr uint16_t MAP_472 = 472;
constexpr uint16_t MAP_473 = 473;
constexpr uint16_t MAP_VERLA_SHORE = 474;
...
constexpr uint16_t MAP_LAKE_SHRINE_EXTERIOR = 523;
constexpr uint16_t MAP_LAKE_SHRINE_EXTERIOR_WITH_MAGMA = 524;
constexpr uint16_t MAP_ROUTE_AFTER_DESTEL_VIEWPOINT = 525;
...
constexpr uint16_t MAP_GUMI_EXTERIOR = 601;
constexpr uint16_t MAP_GUMI_EXTERIOR_VARIANT_DESERTED = 602;
constexpr uint16_t MAP_GUMI_EXTERIOR_VARIANT_HAPPY = 603;
...
constexpr uint16_t MAP_RYUMA_INN = 623;
constexpr uint16_t MAP_RYUMA_INN_VARIANT = 624;
...
constexpr uint16_t MAP_MERCATOR_DOCKS_SUPPLY_SHOP = 660;
constexpr uint16_t MAP_MERCATOR_DOCKS_SUPPLY_SHOP_WITH_ITEMS = 661;
...
constexpr uint16_t MAP_VERLA_EXTERIOR = 711;
constexpr uint16_t MAP_VERLA_SAVED_VARIANT = 712;
